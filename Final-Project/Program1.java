...
public class Program1 {
    public static void main(String[] args) {
        ...
        boolean exit = false;
        System.out.println("Spreadsheet Program1 - Basic Storage and S2V File I/O");
        while (!exit) {
            System.out.println("\nMenu:");
            System.out.println("1. Set cell content");
            System.out.println("2. Get cell content (text)");
            System.out.println("3. Load spreadsheet from file");
            System.out.println("4. Save spreadsheet to file");
